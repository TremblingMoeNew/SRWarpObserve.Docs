...
| 崩坏:星穹铁道抽卡导出工具<br/> Star Rail Gacha Exporter<br/> [DancingSnow0517/StarRail-gacha](https://github.com/DancingSnow0517/StarRail-gacha) | Windows | `star-rail-gacha` | :x:  | :x: | :heavy_exclamation_mark::heavy_exclamation_mark: | :x: |  
...
| PaiGram<br/>[PaiGramTeam/HonkaiStarRailGram](https://github.com/PaiGramTeam/HonkaiStarRailGram) | Telegram Bot | `PaiGram` | :white_check_mark: | :grey_question: | :white_check_mark: | :grey_question: |  
